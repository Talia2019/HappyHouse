    ...
    <h1>부동산 실시간 거래정보</h1>
      <b-row align-h="end">
        <b-button @click="starHouseList" style="background-color: #2186C4">
          <b-img :src='require("@/assets/img/star.png")' style="width:30px;height:30px;"></b-img>
        </b-button>
      </b-row>
...
const memberStore = "memberStore"
  ...
  methods: {
    ...mapActions(["getSido", "getGugun", "getDong", "getHouse", "getOverlapHouse", "getStarHouse"]),
    ...mapMutations(["CLEAR_SIDO_LIST", "CLEAR_GUGUN_LIST", "CLEAR_DONG_LIST", "CLEAR_HOUSE_LIST", 
                      "CLEAR_APT_LIST", "CLEAR_DEAL_LIST", "SET_STAR_HOUSE_LIST"]),
    sidoList() {
      this.getSido();
    },
    gugunList() {
